...
function CalendarPresentation({ plan, items, period, company, onSelectDate }) {
...
function CalendarModule({ manager, company }) {
  ...
  return <section className="calendar-module">
    ...
    {preview && viewMode === "month" && <CalendarPresentation plan={plan} items={periodItems} period={period} company={company} onSelectDate={(date) => { setSelectedDate(date); setViewMode("day"); }} />}
    {preview && viewMode === "week" && <WeekPresentation items={periodItems} selectedDate={selectedDate} onSelectDate={(date) => { setSelectedDate(date); setViewMode("day"); }} />}
