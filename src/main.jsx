...
function MonthStructureModule({ company }) {
  const [period, setPeriod] = useState(() => new Date().toISOString().slice(0, 7));
  const [form, setForm] = useState({ strategySummary: "", postsPerWeek: 0, postsDetail: "", videosPerMonth: 0, videosDetail: "", videoSchedule: "", videoBoostDetail: "", mainLines: "" });
